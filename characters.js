...
export class monk extends character{
    constructor(x, y, isPlayer, direction){
        ...
        this.spriteWidth = 288;
        this.spriteHeight = 128;
        this.spriteOffsetX = 163;
        this.spriteOffsetY = 107;
        this.drawOffsetX = 0;
        this.drawOffsetY = 0;
        this.spriteColliderWidth = 35;
        this.spriteColliderHeight = 43;
        this.img.src = './sprites/monk/ground_monk_FREE_v1.3-SpriteSheet_288x128.png'
    }
    ...
    attackLogicPlayer(){
        if(this.currentAttack == 1){
            ...
            this.attackCollider.width = this.spriteCollider.width*3.45
            this.attackCollider.y = this.spriteCollider.y;
            this.attackCollider.height = this.spriteCollider.height;  
        }
        else if(this.currentAttack == 2){
